...
**Computer Science @ UFU** · **Backend & Systems Developer**
...
- Computer Science (5th semester) at Universidade Federal de Uberlândia
- Backend and full-stack systems development
- **Arch Linux** + **Hyprland** daily driver
- Currently exploring **Go** and distributed systems
- Building **lazyfix** — a TUI invoice reconciliation tool in **Rust** + **Ratatui**
...
### lazyfix
**TUI-based invoice reconciliation** built with Rust and Ratatui.

A terminal user interface for reconciling invoices — efficient, keyboard-driven,
...
![GitHub Stats](https://github-stats-extended.vercel.app/api?username=matheusmedrado&show_icons=true&theme=tokyonight&hide_border=true&start_date=2026-01-01)
